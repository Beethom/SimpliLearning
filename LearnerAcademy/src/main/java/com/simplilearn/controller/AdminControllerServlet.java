...
public class AdminControllerServlet extends HttpServlet {
	...
	private void studentsList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/LearnerAcademy/list-students.jsp");
	...
	private void teachersList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// get students from db util
		List<teacher> teachers = Teacher.getTeacherList();

		// add students to the request
		request.setAttribute("TEACHERS_LIST", teachers);

		// send it to the jSP view page
		RequestDispatcher dispatcher = request.getRequestDispatcher("/LearnerAcademy/teachers-list.jsp");
		dispatcher.forward(request, response);
	...
	private void subjectList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<Subject> subjects = Subjects.getSubjectList();

		// add subjects to the request
		request.setAttribute("SUBJECTS_LIST", subjects);

		// send it to the jSP view page
		RequestDispatcher dispatcher = request.getRequestDispatcher("/LearnerAcademy/subjects-list.jsp");
		dispatcher.forward(request, response);
...
//		// get subjects from db util
//		List<classes> Classes =Class.getClassList();
//
//		// add subjects to the request
//		request.setAttribute("CLASSES_LIST", Classes);
//
//		// send it to the jSP view page
//		RequestDispatcher dispatcher = request.getRequestDispatcher("/LearnerAcademy/classes-list.jsp");
//		dispatcher.forward(request, response);
//
//	}
...
//			classestList(request, response);
//		} else {
//			RequestDispatcher dispatcher = request.getRequestDispatcher("/LearnerAcademy/login.jsp");
//			dispatcher.forward(request, response);
//		}
//
//	}
	...
	private void classStudentsList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// get subjects from db util
		List<Student> students = Class.loadClassStudents(classId);
		...
		// send it to the jSP view page
		RequestDispatcher dispatcher = request.getRequestDispatcher("/LearnerAcademy/class-students.jsp");
		dispatcher.forward(request, response);
